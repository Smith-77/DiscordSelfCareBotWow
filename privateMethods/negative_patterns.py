...
stress_keywords = ['stress','anxiety','anxious','stressed','tired', 'scared', 'afraid', 'fear']
...
school_keywords = ['school','homework','test','quiz','paper','anxious','stressed','tired', 'scared', 'afraid', 'fear']
...
def get_depression_response():
    ...
    resource3 = "  -  Please remember you are always loved: https://media.discordapp.net/attachments/803257943645880323/805302433390788648/giphy_5.gif"
...
def contains_depression_traces(message_content):
    depression_keywords = ['hate myself','end my life','depression','anxiety','anxious','depressed','I want to die','self harm','cut myself',"I don't wnat to live",'sad','mental health','suicide','kill myself']
...
def contains_stress_traces(message_content):
    ...
    negative_sentiment = sentiment_dict['neg']
    positive_sentiment = sentiment_dict['pos']
    message_is_stressed = negative_sentiment > .85 or (negative_sentiment > .6 and positive_sentiment < .4)
